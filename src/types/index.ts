...
export interface GeneratorInput {
  gradeLevel: string; // Allow any string, but prefer 'K-2' | '3-5' | '6-8'
  duration: number; // Allow any number, but prefer 30 | 45 | 60
  environment: 'indoor' | 'outdoor';
  standards: string[];
  equipmentLevel?: string; // Allow any string, but prefer 'minimal' | 'standard' | 'full'
  activityPreferences?: {
    teamBased?: boolean;
    competitive?: boolean;
    creative?: boolean;
